 ...
 */
public class webcube_check extends Border
{
	
	include "../../../../../../../flex3_sdk/frameworks/projects/framework/src/mx/core/Version.as";
	...
	private static var B:BitmapData = null;	       	
	...
	public function webcube_check()
	{
		super();
		  ...
		  var r:Rectangle = t.getCharBoundaries(0);												
		  B = new BitmapData(r.width, r.height, true, 0x000000 );
	 	  B.draw(t,new Matrix(1,0,0,1,-r.x,-r.y));
		}
	...
	override protected function updateDisplayList(w:Number, h:Number):void
	{
		...
		if (bDrawCheck)
		{
			...
			*/
        		...
        		graphics.beginBitmapFill(B,new Matrix(1,0,0,1,(w-B.width)/2,(h-B.height)/2-1),false);	  
        		graphics.drawRect((w-B.width)/2,(h-B.height)/2-1,B.width,B.height);  
        		graphics.endFill();    				
